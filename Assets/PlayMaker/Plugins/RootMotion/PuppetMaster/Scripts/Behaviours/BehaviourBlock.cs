...
namespace RootMotion.Dynamics {
	...
	/// </summary>
	[AddComponentMenu("Scripts/RootMotion.Dynamics/PuppetMaster/Behaviours/BehaviourBlock")]
	public class BehaviourBlock : BehaviourBase {
        ...
        private const string typeSpring = "BehaviourBlock";
		...
		public PuppetEvent onLoseBalance;
				...
				public PuppetEvent onBlockStart;
